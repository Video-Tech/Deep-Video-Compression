...
def forward_model(model, cooked_batch, ctx_frames, args, v_compress,
    ...
    (encoder_h_1, encoder_h_2, encoder_h_3,
     decoder_h_1, decoder_h_2, decoder_h_3, decoder_h_4) = init_rnn(batch_size,
                                                                      ...
                                                                      width,
                                                                      args)
    (old_encoder_h_1, old_encoder_h_2, old_encoder_h_3, _, _, _ , _) = init_rnn(batch_size, height, width, args)
    ...
    old_binarizer = torch.load("./../bm/model/wunet_binarizer_30000")
    for _ in range(iterations):
        ...
        code = torch.cat([new_codes, old_codes], dim=1)
